...
class Node:
    ...
    def generate_states(self, finalout, visited, goalstate, nodesetout):
        ...
        if (miss_x !=2): 
            ...
            temp_right.heuristic = Node.calculate_manhattan(temp_right, goal_state)
        ...
        if (miss_x!=0):
            ...
            temp_left.heuristic = Node.calculate_manhattan(temp_left, goal_state)

            if Node.not_in(temp_left, visited):
                visited.append(temp_left)
                final.append(temp_left)
        ...
        if (miss_y!=0):
            ...
            temp_up.heuristic = Node.calculate_manhattan(temp_up, goal_state)

            if Node.not_in(temp_up, visited):
                visited.append(temp_up)
                final.append(temp_up)
        ...
        if (miss_y!=2):
            ...
            temp_down.heuristic = Node.calculate_manhattan(temp_down, goal_state)

            if Node.not_in(temp_down, visited):
                visited.append(temp_down)
                final.append(temp_down)
